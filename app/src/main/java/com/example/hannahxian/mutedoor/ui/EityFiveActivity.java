...
public class EityFiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eity_five);
    ...
    private void setData() {
        ...
        Util.setText(mShangxiafang,String.valueOf((float) (mDoorWidth+44)/2));
    ...
    private void getData() {
        ...
        mGlassHeight = 203;
        mGlassWidth = ((float)(mDoorWidth + 42) / 2) - 148;
    }
}
